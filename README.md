...
1.  **`.vscode`**: This directory contains workspace configuration files to get you moving faster with Gatsby, Astroturf, and Tailwind CSS.
...
13. **`postcss.config.js`**: A configuration file for [postcss](https://postcss.org/) setup with some simple defaults to work with tailwindcss and astroturf.
