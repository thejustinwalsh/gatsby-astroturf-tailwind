...
1.  **Create a Gatsby site.**
    ...
    Use the Gatsby CLI to create a new site, specifying the gatsby-astroturf-tailwind starter.

    ```shell
    # create a new Gatsby site using the gatsby-astroturf-tailwind starter
    gatsby new my-tailwind-starter https://github.com/thejustinwalsh/gatsby-astroturf-tailwind
    ```
...
1.  **`.github/*`**: Github actions to automatically deploy your gatsby site to github pages on push (delete or condigure with an ACCESS_TOKEN)

2.  **`.vscode/*`**: This directory contains workspace configuration files to get you moving faster with Gatsby, Astroturf, and Tailwind CSS.
...
6. **`.prettierignore`**: This is a configuration file for [Prettier](https://prettier.io/). It allows for ignoring diretories we do not want to consider for running the tool against.
...
16. **`tailwind.config.js`**: A barebones configuration file for [tailwindcss](https://tailwindcss.com/).
